...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.next_quiz_question = {'previous_questions': [],
                                   'quiz_category': {
                                       'type': 'Science',
                                       'id': 1
                                   }}
        self.next_quiz_question_404 = {'previous_questions': []}
    ...
    def test_405_if_question_method_not_allowed(self):
    ...
    def test_delete_question(self):
        ...
        data = json.loads(res.data)
        Question.query.filter(Question.id == 2).one_or_none()
    ...
    def test_quizz(self):
        res = self.client().post("/quizzes", json=self.question_request)
        data = json.loads(res.data)
    ...
    def test_405_if_quizz_invalid_request_body(self):
    ...
    def test_404_non_found_category(self):
